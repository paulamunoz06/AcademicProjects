...
public class GUINewCompany extends javax.swing.JDialog {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        String sectorStr = cboSector.getSelectedItem().toString();
        String email = txtEmail.getText().trim();
        String password = txtPassword.getText().trim();
        
        Sector sector = Sector.valueOf(sectorStr.toUpperCase()); 

        Company company = new Company(nit, nombre, phone, paginaWeb, sector, email, password);
        
        try{
            
            companyService.saveCompany(company);
            this.dispose();
            Messages.showMessageDialog("Empresa de nit "+nit+" registrada correctamente", "Registro correcto");
            ...
            mapError.put("nit", txtNit);
            mapError.put("nombre", txtName);
            mapError.put("phone", txtPhone);
            mapError.put("paginaWeb", txtPaginaWeb);
            mapError.put("sector", cboSector);
            mapError.put("email", txtEmail);
            mapError.put("password", txtPassword);
